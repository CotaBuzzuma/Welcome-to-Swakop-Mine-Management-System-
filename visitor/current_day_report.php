...
<body>
  <div id="main">
    ...
    <div id="site_content">
      ...
      <div class="content">
        <h1>Current Day Report</h1>
		<?php
	
	include('config2.inc');
	$sql = "SELECT a.checkin_id,b.st_rollnumber,b.st_name, a.time_in, a.time_out FROM visitor_record a, st_detail b WHERE b.visitor_id = a.visitor_id AND  DATE(a.time_in)=DATE(NOW()) ORDER BY time_in";
...
<tr>
<td colspan="4"><strong>Student List Which comes in library Today </strong> </td>
</tr>

...
<body>
    ...
    <div id="site_content">
     ...
     <div id="sidebar_container">
      ...
      <div class="content">
       ...
       <form name="form1" method="post"  action="check_in_ac.php">
  <table width="64%" height="168" border="0" cellpadding="3" cellspacing="1">
    ...
    <tr>
      <td width="95" height="43">visitor id </td>
      <td width="15">:</td>
      <td width="297"><input name="visitor_id" type="text" id="visitor_id" /></td>
    </tr>
    ...
    <footer>
      <p>Copyright &copy; 2017 Welcome to Swakop Mine Management System!!!! </a> | <a  </a></p>
    </footer>
  </div>
  <p>&nbsp;</p>
